...
The Skill reads this file at the start of each session and extracts these fields as parameters for the entire pipeline. For missing fields, see **Section 5 — Edge Cases, Case 2**.
...
## 5. Edge Cases — Exception Handling Logic
